import{i as e,l as t,n,o as r,s as i,u as a}from"./index-PF7cBQnX.js";var o=a(t(),1),s={ground:`#17130f`,panel:`#1d1913`,elev:`#241f19`,amber:`#d9a441`,amberHot:`#f59e0b`,amberDeep:`#d97706`,cream:`#f3ede1`,creamSoft:`#b7ab98`,dim:`#8a7c68`,dimmer:`#6b6154`,emerald:`#6ee7b7`,rust:`#f3a5a5`,line:`rgba(217, 164, 65, 0.14)`,lineStrong:`rgba(217, 164, 65, 0.3)`,grad:`linear-gradient(100deg, #d9a441, #f59e0b, #b45309, #d9a441)`},c=`156px`,l=e`
...
end`})]})]}),(0,Q.jsxs)(F,{children:[(0,Q.jsxs)(I,{$i:0,children:[(0,Q.jsx)(`h3`,{children:`The gate lives in the model`}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`code`,{children:`approvable?`}),` and the reason a decision was blocked are defined on `,(0,Q.jsx)(`code`,{children:`SitterApplication`}),`, not in the admin controller. The rule travels with the record, so no future code path can approve around it.`]})]}),(0,Q.jsxs)(I,{$i:1,$tone:`warn`,children:[(0,Q.jsx)(`h3`,{children:`Overrides leave a trace`}),(0,Q.jsx)(`p`,{children:`Approving despite a flagged report is allowed — a dispute can be legitimate — but it sets a boolean on the application. “Who approved a sitter whose check wasn’t clear” has to be answerable later.`})]}),(0,Q.jsxs)(I,{$i:2,children:[(0,Q.jsx)(`h3`,{children:`Statuses are allow-listed`}),(0,Q.jsxs)(`p`,{children:[`The report handler only accepts `,(0,Q.jsx)(`code`,{children:`clear`}),`, `,(0,Q.jsx)(`code`,{children:`consider`}),`, `,(0,Q.jsx)(`code`,{children:`suspended`}),` and `,(0,Q.jsx)(`code`,{children:`dispute`}),`. An unrecognised status is ignored rather than written through into a field the approval gate reads.`]})]}),(0,Q.jsxs)(I,{$i:3,$tone:`warn`,children:[(0,Q.jsx)(`h3`,{children:`Consent is validated, not implied`}),(0,Q.jsxs)(`p`,{children:[(0,Q.jsx)(`code`,{children:`background_check_consent`}),` is an acceptance validation on the application itself — an applicant cannot reach the screening step without it, and the record carries proof that they agreed.`]})]}),(0,Q.jsxs)(I,{$i:4,children:[(0,Q.jsx)(`h3`,{children:`An applicant is never charged twice`}),(0,Q.jsx)(`p`,{children:`A succeeded fee that isn’t yet attached to an application is picked up by the next attempt rather than billing the non-refundable $50 again — and the charge itself carries an idempotency key scoped to the card used.`})]}),(0,Q.jsxs)(I,{$i:5,children:[(0,Q.jsx)(`h3`,{children:`The whole integration is optional`}),(0,Q.jsxs)(`p`,{children:[`Without an API key configured, `,(0,Q.jsx)(`code`,{children:`CheckrConfig.configured?`}),` is false and the invitation step no-ops. Local development and CI never reach out to a real screening provider.`]})]})]}),(0,Q.jsxs)(L,{children:[(0,Q.jsx)(N,{children:(0,Q.jsx)(M,{children:(0,Q.jsx)(`img`,{src:re,alt:`The Background Check Disclosure legal page, explaining what is screened, who performs it, and the applicant's rights.`,loading:`lazy`})})}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h3`,{children:`The disclosure is a page, not a checkbox`}),(0,Q.jsx)(`p`,{children:`Consent to a background check is a legal act with its own requirements, so it gets a real page explaining who performs the screening, what it covers, and what the applicant can do about a result they dispute.`}),(0,Q.jsx)(`p`,{children:`It is linked from the footer of every page and from the application flow itself, so the terms an applicant is agreeing to are reachable before they agree rather than buried in an acceptance checkbox.`})]})]}),(0,Q.jsxs)(R,{children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`b`,{children:`$50`}),(0,Q.jsx)(`span`,{children:`Application fee`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`b`,{children:`0`}),(0,Q.jsx)(`span`,{children:`SSNs stored`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`b`,{children:`HMAC`}),(0,Q.jsx)(`span`,{children:`Webhook auth`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`b`,{children:`4`}),(0,Q.jsx)(`span`,{children:`Accepted statuses`})]})]})]})}),(0,Q.jsx)(D,{id:`money`,className:a(`money`),children:(0,Q.jsxs)(y,{children:[(0,Q.jsxs)(j,{children:[(0,Q.jsx)(O,{children:`Money · Stripe Connect`}),(0,Q.jsx)(k,{children:`The charge sits outside the transaction, deliberately.`}),(0,Q.jsx)(A,{children:`Accepting a bid charges the owner’s stored card, routes the money to the sitter’s Connect account, and keeps 15% as an application fee. A charge is an irreversible external side effect, and a database transaction is a thing that can be undone — so the two are never allowed to overlap. The accept path is built in three phases to guarantee it.`})]}),(0,Q.jsxs)(K,{children:[(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`h4`,{children:`Reserve, under the lock`}),(0,Q.jsxs)(`p`,{children:[`Re-check the guards and write a `,(0,Q.jsx)(`code`,{children:`pending`}),` payment row carrying a freshly generated idempotency key. Local writes only — nothing external is touched.`]})]}),(0,Q.jsxs)(`li`,{className:`pivot`,children:[(0,Q.jsx)(`h4`,{children:`Commit`}),(0,Q.jsx)(`p`,{children:`The transaction closes here. From this moment the reservation is durable, so the already-paid guard is backed by a committed row before a single cent moves.`})]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`h4`,{children:`Charge, outside any transaction`}),(0,Q.jsxs)(`p`,{children:[`One `,(0,Q.jsx)(`code`,{children:`PaymentIntent`}),`, confirmed off-session, with a destination transfer and an application fee. Nothing can roll it away, because there is nothing to roll back into.`]})]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`h4`,{children:`Promote the bid`}),(0,Q.jsxs)(`p`,{children:[`Only now does the bid become `,(0,Q.jsx)(`code`,{children:`accepted`}),` and the competing bids get rejected. The bid is never in a state the money doesn’t back.`]})]})]}),(0,Q.jsxs)(A,{style:{marginTop:34},children:[`The ordering is the whole design. A payment provider has no way of knowing that a database transaction rolled back, so the reservation is committed `,(0,Q.jsx)(`i`,{children:`before`}),` any money moves — which means the guard against charging an owner twice is backed by a durable row rather than one that could disappear from underneath it.`]}),(0,Q.jsxs)(G,{children:[`app/controllers/api/`,(0,Q.jsx)(`b`,{children:`received_bids_controller.rb`})]}),(0,Q.jsxs)(W,{children:[`@bid.with_lock do
